...
public class LockUser extends JFrame{
    ...
    public LockUser(){
        setTitle("Block user - Chat programming"); //set title for registration window
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    if (rs.next()) {
                        ...
                        String sql = "update user set stateAcc = '"+state+"' where id ='" + id + "' and username='"+username+"'";
                        Statement stm = conn.createStatement();
                        stm.executeUpdate(sql);
                        JOptionPane.showConfirmDialog(null, "Block successful");
                        dispose();
                        new EditUser();
